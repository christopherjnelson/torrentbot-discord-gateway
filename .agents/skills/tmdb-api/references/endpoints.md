...
| TV details | `GET /tv/{series_id}` | positive numeric path ID | `[docs 2026-07-24]` `[impl+tests]` |
...
No discover, multi-search, credits, image, season, episode, or authentication
session endpoint is used. `[impl+tests]`
